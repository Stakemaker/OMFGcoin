...
// OMFGcoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xcf, 0xbe, 0xb4, 0xfc };
static unsigned char pchMessageStartOMFGcoin[4] = { 0xcf, 0xe8, 0xe9, 0xfc };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartOMFGcoin : pchMessageStartBitcoin, sizeof(pchMessageStartOMFGcoin));
}
