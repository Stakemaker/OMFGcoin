...
// Copyright (c) 2014 The OMFGcoin developers
...
// for both OMFGcoind and OMFGcoin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of OMFGcoin releases, the client name should be selected from
