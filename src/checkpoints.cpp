...
namespace Checkpoints
{
    ...
    // OMFGcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // OMFGcoin: get last synchronized checkpoint
    ...
    // OMFGcoin: only descendant of current sync-checkpoint is allowed
    ...
    // OMFGcoin: reset synchronized checkpoint to last hardened checkpoint
...
// OMFGcoin: sync-checkpoint master key
...
// OMFGcoin: verify signature of sync-checkpoint message
...
// OMFGcoin: process synchronized checkpoint
