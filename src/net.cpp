...
// Copyright (c) 2011-2015 The OMFGcoin developers
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "OMFGcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are OMFGcoin dns seeds.
static const char *strDNSSeed[][2] = {
        {"seed", "seed.OMFGcoin.org"},
        {"seed2", "seed2.OMFGcoin.org"},
        {"seed3", "seed3.OMFGcoin.org"},
        {"seed4", "seed4.OMFGcoin.org"},
        {"seed5", "seed5.OMFGcoin.org"},
        {"seed6", "seed6.OMFGcoin.org"},
        {"seed7", "seed7.OMFGcoin.org"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // OMFGcoin enables dns seeding with testnet too
    {
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer.  OMFGcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // OMFGcoin: mint proof-of-stake blocks in the background
