...
public:
    ...
    {
        // OMFGcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // OMFGcoin: get transaction coin age
...
public:
    ...
    // OMFGcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // OMFGcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // OMFGcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // OMFGcoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // OMFGcoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // OMFGcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // OMFGcoin: block index flags
    enum  
    {
